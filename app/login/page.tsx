  ...
  return (
    <div className="min-h-screen bg-black flex justify-center items-center">
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-10 w-[450px]">
        ...
        <button
          onClick={register}
          className="w-full bg-green-600 hover:bg-green-700 text-white p-4 rounded-xl mb-3"
        >
          إنشاء حساب جديد
        </button>
        ...
        <button
          ...
          className="w-full bg-white hover:bg-gray-100 text-black p-4 rounded-xl flex items-center justify-center gap-3 font-medium"
        >
