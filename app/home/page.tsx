    ...
    <div style={{ backgroundColor: "#000", minHeight: "100vh", color: "white", direction: "rtl" }}>
      ...
      <nav style={{ backgroundColor: "#1a1a1a", borderBottom: "2px solid #ff9900", padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
          <a href="/about" style={{ color: "#ccc", fontSize: "14px", textDecoration: "none" }}>السيرة الذاتية</a>
      ...
      {settings && (
        <div style={{ backgroundColor: "#0f0f0f", borderTop: "1px solid #222", padding: "40px 16px", direction: "rtl" }}>
          <div style={{ maxWidth: "900px", margin: "0 auto" }}>
            ...
            {/* Contact Info */}
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "16px", marginBottom: "28px" }}>
              {settings.phone && (
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "16px", flexWrap: "wrap" }}>
              {settings.whatsapp && (
                <a href={`https://wa.me/${settings.whatsapp.replace(/\D/g,"")}`} target="_blank" rel="noreferrer"
                  style={{ backgroundColor: "#25D366", color: "white", width: "50px", height: "50px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
              ...
              {settings.instagram && (
                <a href={settings.instagram.startsWith("http") ? settings.instagram : `https://instagram.com/${settings.instagram}`} target="_blank" rel="noreferrer"
                  style={{ background: "linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)", color: "white", width: "50px", height: "50px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
              ...
              {settings.facebook && (
                <a href={settings.facebook.startsWith("http") ? settings.facebook : `https://facebook.com/${settings.facebook}`} target="_blank" rel="noreferrer"
                  style={{ backgroundColor: "#1877F2", color: "white", width: "50px", height: "50px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
